...
El servidor de aplicaciones, el motor de base de datos y las versiones se definirán al preparar el entorno.
...
Las instrucciones de instalación y ejecución se incorporarán cuando esté preparada y comprobada la base del proyecto.
